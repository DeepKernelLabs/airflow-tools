...
from airflow_tools.providers.data_lake.operators.data_lake import (
...
def test_data_lake_check_operator(dag, s3_bucket, s3_resource, s3_client):
    # Create entity for testing
    s3_resource.Object(s3_bucket, 'source1/entity1/2023-10-01/part0001.jsonl').put(
        Body='{"id":1}\n{"id":2}\n'
    )
    ...
    with dag:
        ...
        res_incorrect_prefix = DataLakeCheckOperator(
            ...
            data_lake_conn_id='data_lake_test',
            data_lake_path=s3_bucket + '/source1/entity2/{{ ds }}/',
        )
